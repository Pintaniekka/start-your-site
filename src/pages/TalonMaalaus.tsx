...
const TalonMaalaus = () => {
  ...
  const benefits = ['2 vuoden takuu työlle', 'Ammattimaiset pohjatöt', 'Laadukaat Teknos-maalit', 'Siisti ja huolellinen jälki', 'Ilmainen arviointi', 'Toiminta-alue: Pirkanmaa'];
  const services = [{
    name: 'Puutalon ulkomaalaus',
    description: 'Lautaverhoilut, hirsi- ja paneelipinnat'
  }, {
    name: 'Rappauksen maalaus',
    description: 'Kivitalot ja rapatut pinnat'
  }, {
    name: 'Ikkunat ja ovet',
    description: 'Puuikkunoiden ja ovien kunnostus'
  }, {
    name: 'Kuistit ja terassit',
    description: 'Terassien ja kuistien maalaus'
  }];
  return <div>
      <ServicePageHero title="Talon maalaus" subtitle="Ammattitaitoinen ulkomaalaus laadukkailla materiaaleilla – 2 vuoden takuu" backgroundImage={heroImage} />
      ...
      <section className="section-padding bg-background">
        <div className="section-container">
          ...
          once: true
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Tarjoamme kattavat ulkomaalauspavelut kaikenlaisiin taloihin.</p>
          </motion.div>
